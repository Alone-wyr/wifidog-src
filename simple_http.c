 ...
 * NULL returned on error.
  执行一个HTTP的请求...调用者需要释放request 和 reponse.
  	request作为参数传递.... response作为返回值返回了..
